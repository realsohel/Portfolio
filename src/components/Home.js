    ...
    return (
        <>
            ...
            <div className="lg:flex  ">
                <div className='lg_image boder lg:block rounded-3xl hidden  mt-12 ml-20 h-[34rem] w-[40%]  z-10'>
                <img src={manlg} alt="man" className=' h-[100%] w-[100%] rounded-3xl border border-[#05F2F2]' />
                </div>
